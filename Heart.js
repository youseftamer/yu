...
module.exports = Maria = async (Maria, m, msg, chatUpdate, store) => {
  try {
    ...
    const groupMetadata = m.isGroup
      ? await Maria.groupMetadata(m.chat).catch((e) => {})
      : "";
    ...
    if (global.autorecordtype) {
      ...
      let Ayushrecordinfinal =
        Ayushrecordin[Math.floor(Math.random() * Ayushrecordin.length)];

      Maria.sendPresenceUpdate(Ayushrecordinfinal, from);
    }

    if (autobio) {
      Maria.updateProfileStatus(
        `ازيك يصاحبي 🌟 بوت مصلحي تحتا امرك ف اي وقت يغالي Made BY:youseftamer Inc. 🚀 ${runtime(
          process.uptime(),
        )} `,
      ).catch((_) => _);
    }
      ...
      if (budy.includes("https://")) {
        ...
        Maria.sendMessage(
          from,
          {
            text: `\`\`\`「 Link Detected 」\`\`\`\n\n@${
              m.sender.split("@")[0]
            }   ممنوع ارسال اي لنك طبقا ل Rule 3 `,
    ...
    if (smallinput.includes(`@994403911787`)) {
      reply(`
                          أنا مصلحي من تيم شوكي 🤙🏻     
                                 اطلب يا هندسه 
  -MATh
  -INTRO
  -ELECTRO
  ...
  -C++
  -Image Processing                 
اكتب اسم الماده الي عايزها 🫶🏻
ولو عايز تتكلم مع الذكاء الاصطناعي اكتب .gpt وبعدها الي انت عايزه
 ولو واجهتك اي مشكله دوس ع الصوره الي فوق وكلمنا ع الرقم 👆
#Team_shoky 🤙🏻
#We_Are_Here
#Hti_Cs_Su`);
    }

    if (smallinput.includes(`math`)) {
      reply(`
                 ,${pushname} عنيا يا 👀🫶🏻 
                  دي قائمه MATH
                 -SUMMARY M
    ...
    if (smallinput.includes(`summary m`)) {
      reply(`click on the link 
                  .......................`);
    }

    if (smallinput.includes(`exams m`)) {
      reply(`click on the link
                  ...................... `);
    }

    if (smallinput.includes(`book m`)) {
      reply(`click on the link
      ...................... `);
    }

    if (smallinput.includes(`intro`)) {
      reply(`,${pushname}  عنيا يا 👀🫶🏻 
                  دي قائمه Intro
                  -SUMMARY I
                  -EXAMS   I
                  -BOOK    I`);
    ...
    if (smallinput.includes(`summary i`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`exams i`)) {
      reply(`Click on the link
         ......................`);
    }

    if (smallinput.includes(`book i`)) {
      reply(`Click on the link
         ......................`);
    }

    if (smallinput.includes(`electro`)) {
      reply(`,${pushname} عنيا يا 👀🫶🏻
         دي قائمه Electro
         -SUMMARY E
         -EXAMS   E
    ...
    if (smallinput.includes(`summary e`)) {
      reply(`Click on the link
         ......................`);
    }
    if (smallinput.includes(`shoky`)) {
      reply(`
                           أنا مصلحي من تيم شوكي 🤙🏻     
                                اطلب يا هندسه 
-MATh
...
#Hti_Cs_Su
    ...
    if (smallinput.includes(`exams e`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`book e`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`oop`)) {
      reply(`,${pushname} عنيا يا 👀🫶🏻
                  دي قائمه OOP
                  -SUMMARY O
                  -EXAMS   O
    ...
    if (smallinput.includes(`summary o`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`exams o`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`book o`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`c++`)) {
      reply(`,${pushname} عنيا يا 👀🫶🏻  
                  دي قائمه C++
                  -SUMMARY C
                  -EXAMS   C
    ...
    if (smallinput.includes(`summary c`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`exams c`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`book c`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`image processing`)) {
      reply(`,${pushname} عنيا يا  👀🫶🏻
                  دي قائمه Image Processing
                  -SUMMARY IMG
                  -EXAMS   IMG
                  -BOOK    IMG`);
    }

    if (smallinput.includes(`summary img`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`exams img`)) {
      reply(`Click on the link
                  ......................`);
    }

    if (smallinput.includes(`book img`)) {
      reply(`Click on the link
                  ......................`);
    }
    ...
    switch (command) {
      ...
      case "setbotpp":
        {
          ...
          if (/webp/.test(mime))
            return reply(`Send/Reply Image With Caption ${prefix + command}`);
          var medis = await Maria.downloadAndSaveMediaMessage(
            quoted,
            "ppbot.jpeg",
          );
          if (args[0] == `full`) {
      ...
      case "block":
        ...
        await Maria.updateBlockStatus(blockw, "block")
          .then((res) => reply(json(res)))
          .catch((err) => reply(json(err)));
        break;
      case "unblock":
        ...
        let blockww = m.mentionedJid[0]
          ...
          : m.quoted
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
        await Maria.updateBlockStatus(blockww, "unblock")
          .then((res) => reply(json(res)))
          .catch((err) => reply(json(err)));
        break;
      case "leave":
      ...
      case "promote":
        ...
        let blockwwwww = m.mentionedJid[0]
          ...
          : m.quoted
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
        await Maria.groupParticipantsUpdate(m.chat, [blockwwwww], "promote")
          .then((res) => reply(json(res)))
          .catch((err) => reply(json(err)));
        break;
      case "demote":
        ...
        let blockwwwwwa = m.mentionedJid[0]
          ...
          : m.quoted
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
        await Maria.groupParticipantsUpdate(m.chat, [blockwwwwwa], "demote")
          .then((res) => reply(json(res)))
          .catch((err) => reply(json(err)));
        break;
      case "setname":
      case "setsubject":
        ...
        if (!isBotAdmins) return reply(mess.botAdmin);
        if (!text) return "Text ?";
        await Maria.groupUpdateSubject(m.chat, text)
      ...
      case "setdesk":
        ...
        if (!isBotAdmins) return reply(mess.botAdmin);
        if (!text) return "Text ?";
        await Maria.groupUpdateDescription(m.chat, text)
          .then((res) => reply(mess.done))
          .catch((err) => reply(json(err)));
        break;
      case "setppgroup":
 ...
 *Message : ${args.join(" ") ? args.join(" ") : "no message"}*\n\n`;
      ...
      case "editinfo":
        ...
        if (!isBotAdmins) return reply(mess.botAdmin);
        if (args[0] === "open") {
          await Maria.groupSettingUpdate(m.chat, "unlocked")
            .then((res) => reply(`Successfully Opened Group Edit Info 🕊️`))
            .catch((err) => reply(json(err)));
        } else if (args[0] === "close") {
          await Maria.groupSettingUpdate(m.chat, "locked")
      ...
      case "grouplink":
        ...
        await Maria.sendMessage(
          ...
          {
            video: {
              url: `https://media.tenor.com/y-DUk6XrHbMAAAPo/gigachad.mp4`,
            },
            caption:
      ...
      case "repo":
        {
          ...
          const scritxt = `*🚀SHOKY-𝑩𝒐𝒕-𝑺𝒄𝒓𝒊𝒑𝒕🚀*\n
  *🌟Creator:* Yousef Tamer \n
  *🌟 Repo:* ${repo.html_url}\n
...
*❝ Dont forget to give a Star ⭐ to the repo.*`;
      ...
      case "owner":
        {
          const repf = await Maria.sendMessage(
            from,
            {
              contacts: {
      ...
      case "checkdeath":
        if (!text)
          return replay(
            `Use Someone's Name, Example : ${prefix + command} Ayush`,
          );
      ...
      case "qc":
        {
          ...
          let ppnyauser = await await Maria.profilePictureUrl(
            m.sender,
            "image",
      ...
      case "ytvideo":
        {
          ...
          if (args.length < 1 || !isUrl(text) || !Ayushvidoh.isYTUrl(text))
            reply(
              `Where is the link??\n\nExample : ${
                prefix + command
      ...
      case "gpt":
        {
          Maria.sendMessage(from, { react: { text: "🤖", key: m.key } });
          if (!q)
            return reply(`ضيف كلام يصحبي. 
Example: ${prefix + command} what is the CS Meaning`);
      ...
      case "rules":
        const helptxt = `_*📍[Rules for SHOKY usage]📍*_\n\n\n*>>>* use -support to get the Official group link in your dm.\n\n*--->* If you want to add SHOKY in your group the contact the owner by *-owner/-mods* \n\n*--->* Dont use wrong command, use the command given in the *-help* list \n\n* Dont spam the bot with commands if Mselhy is not responding, its means the maybe owner is offline or facing internet issue. \n\n*IF YOU DONT FOLLOW THE RULES THEN YOU WILL BE BANNED* 🚫 \n\n\n*©️ yousef Tamer Bots inc* `;
      ...
      case "support":
        ...
        https://api.whatsapp.com/send?phone=+201090952790`;
      ...
      case "info":
        ...
        let ifx = `🌟『SHOKY Bot 』🌟
*🌟Description:* A WhatsApp Bot With Rich  features Made By:yousef NAME Quoted from SHAHD
*🚦Uptime:* ${runtime(process.uptime())}
*🕸Version:* 1.2.0
*👤Creator:*  Yousef Tamer\n
*Powered by TEAM SHOKY*`;
        Maria.sendMessage(
          m.chat,
          {
...
`;
      ...
      case "searchnumber":
        {
          ...
          for (let i = 0; i < randomxx; i++) {
            ...
            var anu = await Maria.onWhatsApp(
      ...
      case "dare":
        ...
        buffer = await getBuffer(
          `https://graph.org/file/8dd92e67cd4019b092f53.jpg`,
        );
        Maria.sendMessage(
          from,
          {
      ...
      case "help":
      case "h":
        const txt = ` شكلك  مدقدق ف الشغلانه  😉 `;
      ...
      case "circlevideo":
        {
          try {
            ...
            await Maria.relayMessage(
              from,
              { ptvMessage: { ...Mariabaileys.videoMessage } },
              {},
            );
          } catch (err) {
...
Cieeee, What's Going On❤️💖👀`,
      ...
      case "nsfwmenu":
        ...
        const nsfwmenu = `NOTHING HERE 
`;
        Maria.sendMessage(
          m.chat,
          { image: { url: "./Gallery/nsfw.jpg" }, caption: nsfwmenu },
          { quoted: m },
        );
        break;
      case "nsfw":
        {
          ...
          if (args[0] === "on") {
            ...
            Maria.sendMessage(
              from,
              { text: `\`\`\``, contextInfo: { mentionedJid: mems } },
              { quoted: m },
            );
          } else if (args[0] === "off") {
...
🟢 *Use 'on' to enable and 'off' to disable.* 🔴`);
      ...
      case "blowjob":
        ...
        var ahegaonsfw = JSON.parse(
          fs.readFileSync("./Gallery/nsfw/blowjob.json"),
        );
        var Mariayresult = pickRandom(ahegaonsfw);
        Maria.sendMessage(
          m.chat,
          { caption: mess.done, image: { url: Mariayresult.url } },
          { quoted: m },
        );
        break;
      ...
      case "foot":
        ...
        if (!isNsfw) return reply(mess.nsfw);
        var ahegaonsfw = JSON.parse(
          fs.readFileSync("./Gallery/nsfw/foot.json"),
        );
        var Mariayresult = pickRandom(ahegaonsfw);
        Maria.sendMessage(
          m.chat,
      ...
      case "gangbang":
        ...
        if (!isNsfw) return reply(mess.nsfw);
        var ahegaonsfw = JSON.parse(
          fs.readFileSync("./Gallery/nsfw/gangbang.json"),
        );
        var Mariayresult = pickRandom(ahegaonsfw);
        Maria.sendMessage(
          m.chat,
      ...
      case "hentai":
        ...
        if (!isNsfw) return reply(mess.nsfw);
        var ahegaonsfw = JSON.parse(
          fs.readFileSync("./Gallery/nsfw/hentai.json"),
        );
        var Mariayresult = pickRandom(ahegaonsfw);
        Maria.sendMessage(
          m.chat,
      ...
      case "pussy":
        ...
        if (!isNsfw) return reply(mess.nsfw);
        var ahegaonsfw = JSON.parse(
          fs.readFileSync("./Gallery/nsfw/pussy.json"),
        );
        var Mariayresult = pickRandom(ahegaonsfw);
        Maria.sendMessage(
          m.chat,
      ...
      case "igimg":
        {
          ...
          Maria.sendMessage(
            m.chat,
            { image: { url: jsonMaria.data.data[0].url }, caption: mess.done },
            { quoted: m },
          ).catch(console.error);
        }
        break;
      ...
      case "gitclone":
        ...
        if (!isUrl(args[0]) && !args[0].includes("github.com"))
          return replygcMaria(`Link invalid!!`);
